...
public class BottomTab extends Fragment implements View.OnClickListener {
    ...
    ImageButton bottomButton1, bottomButton2, bottomButton3, bottomButton4, bottomButton5;
    ...
    public static BottomTab newInstance(String param1, String param2) {
        BottomTab fragment = new BottomTab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_bottom_tab, container, false);
        bottomButton1 = v.findViewById(R.id.bottomButton1);
        bottomButton2 = v.findViewById(R.id.bottomButton2);
        bottomButton3 = v.findViewById(R.id.bottomButton3);
        bottomButton4 = v.findViewById(R.id.bottomButton4);
        bottomButton5 = v.findViewById(R.id.bottomButton5);
    ...
    public void onClick(View v) {
        ...
        switch (v.getTag().toString()) {
            default:
                break;
            case "bottom1":
                DVEditor.putInt("bottom_color", R.drawable.bottom_1_color);
                DVEditor.putInt("bottom_line", R.drawable.bottom_1_line);
                DVEditor.apply();
                break;
            case "bottom2":
                DVEditor.putInt("bottom_color", R.drawable.bottom_2_color);
                DVEditor.putInt("bottom_line", R.drawable.bottom_2_line);
                DVEditor.apply();
                break;
            case "bottom3":
                DVEditor.putInt("bottom_color", R.drawable.bottom_3_color);
                DVEditor.putInt("bottom_line", R.drawable.bottom_3_line);
                DVEditor.apply();
                break;
            case "bottom4":
                DVEditor.putInt("bottom_color", R.drawable.bottom_4_color);
                DVEditor.putInt("bottom_line", R.drawable.bottom_4_line);
                DVEditor.apply();
                break;
            case "bottom5":
                DVEditor.putInt("bottom_color", R.drawable.bottom_5_color);
                DVEditor.putInt("bottom_line", R.drawable.bottom_5_line);
                DVEditor.apply();
                break;
        }
