...
public class SocksTab extends Fragment implements View.OnClickListener {
    ...
    ImageButton socksButton1, socksButton2, socksButton3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        socksButton3 = v.findViewById(R.id.socksButton3);
        socksButton1.setOnClickListener(this);
        socksButton2.setOnClickListener(this);
        socksButton3.setOnClickListener(this);
        return v;
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getTag().toString()) {
            default:
                break;
            case "socks1":
                DVEditor.putInt("socks_color", R.drawable.empty);
                DVEditor.putInt("socks_line", R.drawable.empty);
                DVEditor.apply();
                break;
            case "socks2":
