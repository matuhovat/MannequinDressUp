...
public class ShoesTab extends Fragment implements View.OnClickListener {
    ...
    ImageButton shoesButton1, shoesButton2, shoesButton3, shoesButton4;
    ...
    public static ShoesTab newInstance(String param1, String param2) {
        ShoesTab fragment = new ShoesTab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_shoes_tab, container, false);
        shoesButton1 = v.findViewById(R.id.shoesButton1);
        shoesButton2 = v.findViewById(R.id.shoesButton2);
        shoesButton3 = v.findViewById(R.id.shoesButton3);
        shoesButton4 = v.findViewById(R.id.shoesButton4);
        shoesButton1.setOnClickListener(this);
        shoesButton2.setOnClickListener(this);
        shoesButton3.setOnClickListener(this);
        shoesButton4.setOnClickListener(this);
        return v;
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getTag().toString()) {
            default:
                break;
            case "shoes1":
                DVEditor.putInt("shoes_color", R.drawable.shoes_1_color);
                DVEditor.putInt("shoes_line", R.drawable.shoes_1_line);
                DVEditor.apply();
                break;
            case "shoes2":
                DVEditor.putInt("shoes_color", R.drawable.shoes_2_color);
                DVEditor.putInt("shoes_line", R.drawable.shoes_2_line);
                DVEditor.apply();
                break;
            case "shoes3":
                DVEditor.putInt("shoes_color", R.drawable.shoes_3_color);
                DVEditor.putInt("shoes_line", R.drawable.shoes_3_line);
                DVEditor.apply();
                break;
            case "shoes4":
                DVEditor.putInt("shoes_color", R.drawable.shoes_4_color);
                DVEditor.putInt("shoes_line", R.drawable.shoes_4_line);
                DVEditor.apply();
                break;
        }
